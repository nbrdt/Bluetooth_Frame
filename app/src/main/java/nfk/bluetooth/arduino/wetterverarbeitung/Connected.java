...
import nfk.bluetooth.arduino.wetterverarbeitung.BluetoothBase.*;
import nfk.bluetooth.arduino.wetterverarbeitung.DiagramManaging.*;
...
public class Connected extends AppCompatActivity implements DiagramManager.DataProvider {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case (R.id.main_actionbar_menu_item_settings): {
                ...
                startActivityForResult(startSettings, SettingsActivity.SETTINGSACTIVITY_REQUEST_CODE);
                return true;
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SettingsActivity.SETTINGSACTIVITY_REQUEST_CODE) {
